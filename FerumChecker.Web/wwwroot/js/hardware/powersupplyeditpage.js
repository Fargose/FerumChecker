PowerSupplyEditPage = function () {
    this.Action = null;
}

PowerSupplyEditPage.prototype.init = function (action) {
    var self = this;
    this.Action = action
    ...
    this.initMultiBox($("#power-supply-cpu-select"), "PowerSupplyCPUInterfaces");

    $("form").submit(function (e) {
        e.preventDefault();
        var formData = new FormData(e.target);
        self.addArrayToFormData(formData, self.PowerSupplyCPUInterfaces, "PowerSupplyCPUInterfaces");
        $.ajax({
            url: "/PowerSupply/" + self.Action,
            type: "POST",
            dataType: "html",
            data: formData,
            processData: false,
...
PowerSupplyEditPage.prototype.initMultiBox = function (elem, propertyName) {
    var self = this;
    this.clickInit(elem, propertyName);
}

PowerSupplyEditPage.prototype.clickInit = function (elem, propertyName) {
    var self = this;
...
PowerSupplyEditPage.prototype.removeItem = function (e, propertyname) {
...
PowerSupplyEditPage.prototype.addItem = function (select, list, propertyName) {
...
PowerSupplyEditPage.prototype.addArrayToFormData = function (formData, array, name) {
    if (array) {
